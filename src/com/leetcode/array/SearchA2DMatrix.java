...
public class SearchA2DMatrix {
	...
	public static void main(String args[]) {
		...
		System.out.println(searchMatrix(new int[][]{{-10,-10},{-9,-9},{-8,-6},{-4,-2},{0,1},{3,3},{5,5},{6,8}}, -11));
		System.out.println(searchMatrix(new int[][]{{-10,-10},{-9,-9},{-8,-6},{-4,-2},{0,1},{3,3},{5,5},{6,8}}, -10));
		System.out.println(searchMatrix(new int[][]{{-10,-10},{-9,-9},{-8,-6},{-4,-2},{0,1},{3,3},{5,5},{6,8}}, -7));
		System.out.println(searchMatrix(new int[][]{{-10,-10},{-9,-9},{-8,-6},{-4,-2},{0,1},{3,3},{5,5},{6,8}}, 0));
		System.out.println(searchMatrix(new int[][]{{-10,-10},{-9,-9},{-8,-6},{-4,-2},{0,1},{3,3},{5,5},{6,8}}, 1));
		System.out.println(searchMatrix(new int[][]{{-10,-10},{-9,-9},{-8,-6},{-4,-2},{0,1},{3,3},{5,5},{6,8}}, 6));
		System.out.println(searchMatrix(new int[][]{{-10,-10},{-9,-9},{-8,-6},{-4,-2},{0,1},{3,3},{5,5},{6,8}}, 8));
		System.out.println(searchMatrix(new int[][]{{-10,-10},{-9,-9},{-8,-6},{-4,-2},{0,1},{3,3},{5,5},{6,8}}, 9));
	}
}
